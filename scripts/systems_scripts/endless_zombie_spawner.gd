...
var lane_2_spawn_y_coordinate = 250
var lane_3_spawn_y_coordinate = 350
...
func choose_lane() -> Vector2:
	...
	match lane:
		...
		2: return Vector2(spawn_x_coordinate, lane_2_spawn_y_coordinate)
		3: return Vector2(spawn_x_coordinate, lane_3_spawn_y_coordinate)
		4: return Vector2(spawn_x_coordinate, lane_4_spawn_y_coordinate)
		5: return Vector2(spawn_x_coordinate, lane_5_spawn_y_coordinate)
	return Vector2(spawn_x_coordinate, lane_3_spawn_y_coordinate) #idk what this is for, I made it like a week ago and forogt
#endregion
