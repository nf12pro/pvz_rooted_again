...
#region Variables
var plant_scene: PackedScene = preload("res://scenes/plants/world_1_basic/doom_shroom.tscn")
var overlay_scene: PackedScene = preload("res://scenes/plants/world_1_basic/plant_seeds/overlays/doomshroom_overlay.tscn")
