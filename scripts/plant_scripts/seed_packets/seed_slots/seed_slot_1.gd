...
func _ready() -> void:
	...
	if Global.seed_1 == "Peashooter":
		peashooter_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", peashooter_seed)
	elif Global.seed_1 == "Sunflower":
		sunflower_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", sunflower_seed)
	elif Global.seed_1 == "Gatling Gun":
		gatling_gun_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", gatling_gun_seed)
	elif Global.seed_1 == "Repeater":
		repeater_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", repeater_seed)
	elif Global.seed_1 == "WallNut":
		wallnut_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", wallnut_seed)
	elif Global.seed_1 == "Twin Sunflower":
		twin_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", twin_seed)
	elif Global.seed_1 == "Torchwood":
		torchwood_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", torchwood_seed)
	elif Global.seed_1 == "Plasma Wood":
		plasma_wood_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", plasma_wood_seed)
	elif Global.seed_1 == "Cherry Bomb":
		cherry_bomb_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", cherry_bomb_seed)
	elif Global.seed_1 == "Laser Bean":
		laser_bean_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", laser_bean_seed)
	elif Global.seed_1 == "Tall Nut":
		tallnut_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", tallnut_seed)
	elif Global.seed_1 == "Iceberg Lettuce":
		iceberg_lettuce_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", iceberg_lettuce_seed)
	elif Global.seed_1 == "Doom Shroom":
		doomshroom_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", doomshroom_seed)
	elif Global.seed_1 == "Plasma Pea":
		plasma_pea_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", plasma_pea_seed)
	elif Global.seed_1 == "Snow Pea":
		snow_pea_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", snow_pea_seed)
	elif Global.seed_1 == "Frost Pea":
		frost_pea_seed.position = Vector2(170, 55)
		get_tree().current_scene.call_deferred("add_child", frost_pea_seed)
	elif Global.seed_1 == "Citric Hero":
		citric_hero_seed.position = Vector2(170, 55)
