...
func _ready() -> void:
	...
	if Global.seed_5 == "Peashooter":
		peashooter_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", peashooter_seed)
	elif Global.seed_5 == "Sunflower":
		sunflower_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", sunflower_seed)
	elif Global.seed_5 == "Gatling Gun":
		gatling_gun_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", gatling_gun_seed)
	elif Global.seed_5 == "Repeater":
		repeater_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", repeater_seed)
	elif Global.seed_5 == "WallNut":
		wallnut_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", wallnut_seed)
	elif Global.seed_5 == "Twin Sunflower":
		twin_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", twin_seed)
	elif Global.seed_5 == "Torchwood":
		torchwood_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", torchwood_seed)
	elif Global.seed_5 == "Plasma Wood":
		plasma_wood_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", plasma_wood_seed)
	elif Global.seed_5 == "Cherry Bomb":
		cherry_bomb_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", cherry_bomb_seed)
	elif Global.seed_5 == "Laser Bean":
		laser_bean_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", laser_bean_seed)
	elif Global.seed_5 == "Tall Nut":
		tallnut_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", tallnut_seed)
	elif Global.seed_5 == "Iceberg Lettuce":
		iceberg_lettuce_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", iceberg_lettuce_seed)
	elif Global.seed_5 == "Doom Shroom":
		doomshroom_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", doomshroom_seed)
	elif Global.seed_5 == "Plasma Pea":
		plasma_pea_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", plasma_pea_seed)
	elif Global.seed_5 == "Snow Pea":
		snow_pea_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", snow_pea_seed)
	elif Global.seed_5 == "Frost Pea":
		frost_pea_seed.position = Vector2(610, 55)
		get_tree().current_scene.call_deferred("add_child", frost_pea_seed)
	elif Global.seed_5 == "Citric Hero":
		citric_hero_seed.position = Vector2(610, 55)
