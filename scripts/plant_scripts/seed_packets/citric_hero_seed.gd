...
#region Variables
var plant_scene: PackedScene = preload("res://scenes/plants/world_1_basic/citric_hero.tscn")
var overlay_scene: PackedScene = preload("res://scenes/plants/world_1_basic/plant_seeds/overlays/citric_hero_overlay.tscn")
var overlay_instance: Node2D = null
@export var cost: int = 225
